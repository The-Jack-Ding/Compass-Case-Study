...
The current Week 2 and Week 3 findings are summarized in:

`outputs/reports/week2_week3_readout.md`

## Confidentiality

The CRMLS extracts contain real MLS transaction and agent information. Keep the raw files and row-level derived outputs within the internship program and do not publish or distribute them externally.
